...
### Fixed
* The `stellar-base` dependency has been upgraded to [v10.0.0-beta.4](https://github.com/stellar/js-stellar-base/releases/tag/v10.0.0-beta.4) which contains a bugfix related to large sequence numbers ([#TODO](https://github.com/stellar/js-soroban-client/pull/TODO)).
